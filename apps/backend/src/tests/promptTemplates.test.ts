...
describe('PromptTemplates', () => {
  describe('taskBreakdown', () => {
    it('should generate a comprehensive task breakdown prompt', () => {
      ...
      const prompt = PromptTemplates.taskBreakdown(request);
  ...
  describe('dailyStudyPlan', () => {
    it('should generate a comprehensive daily study plan prompt', () => {
      ...
      const prompt = PromptTemplates.dailyStudyPlan(request);
  ...
  describe('recommendations', () => {
    it('should generate comprehensive recommendations prompt', () => {
      ...
      const prompt = PromptTemplates.recommendations(request);
  ...
  describe('studySessionHints', () => {
    it('should generate comprehensive study session hints prompt', () => {
      ...
      const prompt = PromptTemplates.studySessionHints(request);
  ...
  describe('academicValidation', () => {
    it('should generate academic validation prompt', () => {
      ...
      const prompt = PromptTemplates.academicValidation(content);
    ...
    it('should handle long content by truncating', () => {
      ...
      const prompt = PromptTemplates.academicValidation(longContent);
  ...
  describe('guardrails', () => {
    it('should include academic guardrails in all prompts', () => {
      ...
      const taskPrompt = PromptTemplates.taskBreakdown(taskRequest);
      const planPrompt = PromptTemplates.dailyStudyPlan(planRequest);
      const recPrompt = PromptTemplates.recommendations(recRequest);
      const hintsPrompt = PromptTemplates.studySessionHints(hintsRequest);
